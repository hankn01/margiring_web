...
import BlockWorkspace_Newfile from './BlockWorkspace_Newfile';
            ...
            <div className={`${styles.MainFrame}`}>
                ...
                <div className={`${styles.MiddleContentDiv}`}>
                    <div className={`${styles.BlockCodingDiv}`}>
                        <BlockWorkspace_Newfile /> {/* Blockly Toolbox 및 블록 부분 */}
                    </div>
...
export default Blockcoding_Newfile;